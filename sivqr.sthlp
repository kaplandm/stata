...
{p_end}
{synopt :{opt b:andwidth(#)}}set desired smoothing bandwidth; default is {cmd:bandwidth(-1)}{p_end}
...
{pstd}Run median IVQR with 100 bootstrap replications{p_end}
{phang2}{cmd:. sivqr rent pcturban (hsngval = faminc i.region), q(0.5) reps(100)}{p_end}
